...
static asmlinkage long ig_sys_write(unsigned int fd,
...
static asmlinkage long ig_sys_truncate(const char __user *path, long length)
{
    uint64_t dev, ino;
    long rc = 0;
...
static asmlinkage long ig_sys_ftruncate(unsigned int fd, unsigned long length)
{
    uint64_t dev, ino;
    long rc = 0;
...
static asmlinkage long ig_sys_open(const char __user *filename,
...
static asmlinkage long ig_sys_openat(int dfd, const char __user *filename,
                                      int flags, umode_t mode)
{
...
static asmlinkage long ig_sys_creat(const char __user *pathname, umode_t mode)
{
...
static asmlinkage long ig_sys_unlink(const char __user *pathname)
{
    uint64_t dev, ino;
    long rc = 0;
...
static asmlinkage long ig_sys_unlinkat(int dfd,
...
static asmlinkage long ig_sys_rename(const char __user *oldname,
...
static asmlinkage long ig_sys_renameat(int olddfd,
...
#ifdef __NR_renameat2
static asmlinkage long ig_sys_renameat2(int olddfd,
                                         const char __user *oldname,
                                         int newdfd,
                                         const char __user *newname,
                                         unsigned int flags)
...
static asmlinkage long ig_sys_chmod(const char __user *filename, umode_t mode)
{
    uint64_t dev, ino;
    long rc = 0;
...
static asmlinkage long ig_sys_fchmodat(int dfd,
...
static asmlinkage long ig_sys_chown(const char __user *filename,
...
static asmlinkage long ig_sys_fchownat(int dfd,
                                        const char __user *filename,
...
static asmlinkage long ig_sys_link(const char __user *oldname,
                                    const char __user *newname)
{
    uint64_t dev, ino;
    long rc = 0;
...
static asmlinkage long ig_sys_linkat(int olddfd,
                                      const char __user *oldname,
                                      int newdfd,
                                      const char __user *newname,
                                      int flags)
...
static asmlinkage long ig_sys_setxattr(const char __user *path,
...
static asmlinkage long ig_sys_lsetxattr(const char __user *path,
                                         const char __user *name,
                                         const void __user *value,
                                         size_t size, int flags)
{
...
static asmlinkage long ig_sys_fsetxattr(int fd,
                                         const char __user *name,
                                         const void __user *value,
                                         size_t size, int flags)
{
...
#define HOOK(name) \
    ...
    sys_call_table[__NR_##name] = (sys_call_ptr_t)ig_sys_##name
